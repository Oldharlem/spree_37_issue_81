...
ActiveRecord::Schema.define(version: 2019_09_30_175822) do
  ...
  create_table "spree_mollie_payment_sources", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "payment_id"
